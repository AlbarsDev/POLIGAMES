...
let wordsObj = {
    BOAT: ["AT", "TO", "BAT", "BOT", "OAT", "BOAT"],
    FLOWER: ['FLEW', 'FLOW', 'ROLE', 'FORE', 'WOLF', 'LOWER'],
    PIRATE: ['TAPIR', 'TRAP', 'PEAR', 'RATE', 'RIP', 'TIE'],
    GARDEN: ['GRAND', 'DANGER', 'RANGE', 'DEAR', 'AND', 'RED'],
    SUNSET: ['TUNE', 'SUN', 'SET', 'NET', 'USE', 'NUTS'],
};
